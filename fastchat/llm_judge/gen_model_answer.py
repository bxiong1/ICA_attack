...
def get_model_answers(
    ...
    defense_embeddings = np.load(f'/root/autodl-tmp/FastChat/fastchat/llm_judge/final_defense_embeddings_20_new.npy')
...
if __name__ == "__main__":
    ...
    run_eval(
        ...
        dtype=torch.float16#str_to_torch_dtype(args.dtype),
    )
